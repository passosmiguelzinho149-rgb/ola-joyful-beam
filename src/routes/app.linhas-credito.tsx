...
function Linhas() {
  ...
  return (
    <PhoneFrame>
      ...
      <div className="bg-[#1f2db4] text-white px-4 pb-8">
      ...
      <div className="bg-white flex-1 px-4 py-4 -mt-4 space-y-4">
        <div className="rounded-xl bg-white border border-slate-200 shadow-sm p-4">
          <div className="flex items-start gap-2">
            <Info className="text-[#1f2db4]" size={18} />
            <div>
              ...
              <button className="text-[#1f2db4] font-semibold text-sm mt-2">
          ...
          {lines.map((l) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                {open === l.title ? <ChevronUp size={18} className="text-[#1f2db4]" /> : <ChevronDown size={18} className="text-[#1f2db4]" />}
              </div>
